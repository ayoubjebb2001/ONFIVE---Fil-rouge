                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                @if(auth()->check() && auth()->user()->player && auth()->user()->player->team_id === null)
                                    <button class="btn btn-warning join-team-btn">Join Team</button>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-5">
                            <div class="team-info-box mb-4 p-3 bg-dark rounded">
                                ...
                                <div class="info-item mb-2">
                                    <p class="mb-1"><strong>Creation Date:</strong> {{ $team->created_at->format('Y/m/d') }}</p>
                                </div>
                                <div class="info-item mb-2">
                                    <p class="mb-1"><strong>City:</strong> {{ $team->city }}</p>
                                </div>
                                <div class="info-item">
                                    <p class="mb-1"><strong>Manager:</strong> <span class="text-warning">{{ $team->captain->first_name }} {{ $team->captain->last_name }}</span></p>
                                </div>
                            </div>
                                ...
                                <div class="match-result mb-2">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="team-with-logo">
                                            <img src="{{ asset('teams_imgs/placeholder.jpg') }}" alt="Team Logo" width="40" height="40" class="rounded-circle">
...
<style>
    ...
    .team-info-box, .squad-box, .last-matches-box {
